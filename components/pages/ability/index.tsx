...
import { useAbilities } from "@/utils/hooks/ability";
...
export default function AbilityPage() {
  ...
  const { data, error, isLoading } = useAbilities(query);
    ...
    <main className="container mx-auto max-w-full px-8 flex-grow">
      <section className="w-full flex flex-col gap-6 py-8 tracking-wider">
        ...
        {isLoading ?
          ...
          <h1 className="text-2xl sm:text-4xl font-extrabold">Abilities</h1>}
