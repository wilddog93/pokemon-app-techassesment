...
import { useLocations } from "@/utils/hooks/location";
...
export default function LocationPage() {
  ...
  const { data, error, isLoading } = useLocations(query);
    ...
    <main className="container mx-auto max-w-full px-8 flex-grow">
      <section className="w-full flex flex-col gap-6 py-8 tracking-wider">
        ...
        {isLoading ?
          ...
          <h1 className="text-2xl sm:text-4xl font-extrabold">Locations</h1>}
